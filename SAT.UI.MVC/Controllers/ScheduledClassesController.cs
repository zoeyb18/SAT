...
namespace SAT.UI.MVC.Controllers
{
    public class ScheduledClassesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ScheduledClassId,CourseId,StartDate,EndDate,InstructureName,Location,Scsid")] ScheduledClass scheduledClass)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ScheduledClassId,CourseId,StartDate,EndDate,InstructureName,Location,Scsid")] ScheduledClass scheduledClass)
        {
